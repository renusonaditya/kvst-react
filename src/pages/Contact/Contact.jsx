    ...
    <>
      ...
      <div className="contact-rituals-puja-container">
        <div class="contact-rituals-puja-card">
          ...
          <div class="contact-description-box">
            <div class="contact-description-content">+91-9949441095</div>
          </div>
        </div>
        ...
        <div class="contact-rituals-puja-card">
          ...
          <div class="contact-description-box">
            <div class="contact-description-content">
              Reach us on kashivishwanathtemplemedchal@gmail.com
            </div>
          </div>
        </div>
        ...
        <div class="contact-rituals-puja-card">
          ...
          <div class="contact-description-box">
            <div class="contact-description-content">
              Kashi Vishwanath Temple, Medchal
            </div>
          </div>
        </div>
        ...
        <div class="contact-rituals-puja-card">
          ...
          <div class="contact-description-box">
            <div class="contact-description-content">
              kashivishwanathtemplemedchal.org
            </div>
          </div>
        </div>
        ...
        <div class="contact-rituals-puja-card">
          ...
          <div class="contact-description-box">
            <div class="contact-description-content">
              Kashi Vishwanath Temple, Medchal Page
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="rituals-reach-card">
        ...
        <div class="contact-description-reach-box">
          <div class="description-reach-content">
            Temple is located about 23 kms far from Hyderabad City on Hyderabad
            - Nagpur Highway 44. Devotees may avail bus route easily. Bus Route
            number 229. Buses are available for every 15 minutes from
      ...
      <div class="rituals-reach-card">
        ...
        <div class="contact-description-reach-box">
          <div class="description-reach-content">
            Nearest Railway station from the temple is Medchal Railway Station.
      ...
      <div class="rituals-reach-card">
        ...
        <div class="contact-description-reach-box">
          <div class="description-reach-content">
            Nearest Airport is Rajiv Gandhi International Airport located in
            Shamshabad City, Hyderabad. which is around 70kms from temple.
            Devotees may use Outer Ring Road facility to travel from Airport to
            Temple.
          </div>
        </div>
      </div>
