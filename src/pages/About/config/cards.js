...
export const cards = [
    {
        ...
        well which is located beside <br />
    ...
    },
    {
        ...
        own money <br />
        without collecting funds from anyone.`,
        description: `
        During the time of
        construction,
    ...
    },
    {
        ...
        It was designed as per Agama Shastra.<br />
        `,
        description: `
        Main door of the temple was made during the construction of temple which is about 20 feet height and 13 feet width. <br/>
        2nd entrance of the temple is north facing dwara which is called as Uttara Dwara. It glows holy radiance of Sri Kashi Vishwanath Temple in Varanasi which is about 1000kms away from north facing door of the temple.
        <br />
        <br />
